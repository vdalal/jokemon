...
# Colab reference: https://colab.research.google.com/drive/1wphXmm65dnnTO1tklfnPpReflxXk06St#scrollTo=hoelkOrFY8bN

# We always start with a dataset to train on. Let's download the pokemon name dataset
...
# wget https://raw.githubusercontent.com/cervoise/pentest-scripts/master/password-cracking/wordlists/pokemon-list-en.txt
with open('pokemon-list-en.txt', 'r', encoding='utf-8') as f:
    text = f.read()
...
open('more-jokemon-names.txt', 'w').write(decode(m.generate(context, max_new_tokens=10000)[0].tolist()))